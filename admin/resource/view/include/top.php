...
<html lang="en">
	...
	<?php
		...
		<meta name="author" content="Jobayer Al Mahmud Tuser">
						...
						<?php
							...
							if($_SESSION['SMC_login_admin_type'] == "Root Admin" || $_SESSION['SMC_login_admin_type'] == "Technical Operator")
							{
								...
								<li class="menu-list">
									...
									<ul class="sub-menu-list">
										<li>
											<a href="create-admin"> <i class="fa fa-plus-circle"></i> Create Admin </a>
										</li>
										<li>
											<a href="list-admin"> <i class="fa fa-user"></i> List Admin </a>
										</li>
									</ul>
								</li>
								';
							...
							if($_SESSION['SMC_login_admin_type'] == "Root Admin" || $_SESSION['SMC_login_admin_type'] == "Content Manager")
							{
								...
								<li class="menu-list">
									...
									<ul class="sub-menu-list">
										<li>
											<a href="create-slider"> Add Image Slider </a>
										</li>
										<li>
											<a href="list-slider"> List Image Slider </a>
										</li>
									</ul>
								</li>
								';
							...
							if($_SESSION['SMC_login_admin_type'] == "Root Admin" || $_SESSION['SMC_login_admin_type'] == "Sales Manager")
							{
								...
								<li class="menu-list">
									...
									<ul class="sub-menu-list">
										<li>
											<a href="list-customer"> Customer List </a>
										</li>
										<li>
											<a href="review"> Customer Overview </a>
										</li>
									</ul>
								</li>
								';
							...
							if($_SESSION['SMC_login_admin_type'] == "Root Admin" || $_SESSION['SMC_login_admin_type'] == "Technical Operator")
							{
								...
								<li class="menu-list">
									...
									<ul class="sub-menu-list">
										<li>
											<a href="create-subcategory"> Create Sub Category </a>
										</li>
										<li>
											<a href="list-subcategory"> Sub Category List </a>
										</li>
									</ul>
								</li>
								';
							...
							if($_SESSION['SMC_login_admin_type'] == "Root Admin" || $_SESSION['SMC_login_admin_type'] == "Content Manager")
							{
								...
								<li class="menu-list">
									...
									<ul class="sub-menu-list">
										...
										<li>
											<a href="list-product"> Products List </a>
										</li>
									</ul>
								</li>
								';
							...
							if($_SESSION['SMC_login_admin_type'] == "Root Admin" || $_SESSION['SMC_login_admin_type'] == "Sales Manager")
							{
								...
								<li class="menu-list">
									...
									<ul class="sub-menu-list">
										<li>
										<a href="list-order"> Orders List </a>
										</li>
										<li>
							...
							if($_SESSION['SMC_login_admin_type'] == "Root Admin" || $_SESSION['SMC_login_admin_type'] == "Sales Manager")
							{
								...
								<li class="menu-list">
									...
									<ul class="sub-menu-list">
										...
										<li>
											<a href="pages-details"> Pages Details </a>
										</li>
									</ul>
								</li>';
							}
